...
let lifetimeScore = parseInt(localStorage.getItem('betruegerScoreDE')) || 0;
let completedLessons = JSON.parse(localStorage.getItem('completedBetruegerLessonsDE')) || [];
...
const stations = [
    {file:"01_Ponzi.mp3", title:"1. Charles Ponzi"},
    {file:"02_Lustig.mp3", title:"2. Victor Lustig"},
    {file:"03_Abagnale.mp3", title:"3. Frank Abagnale Jr."},
    {file:"04_Sorokin.mp3", title:"4. Anna Sorokin"},
    {file:"05_Madoff.mp3", title:"5. Bernie Madoff"},
    {file:"06_Holmes.mp3", title:"6. Elizabeth Holmes"},
    {file:"07_MacGregor.mp3", title:"7. Gregor MacGregor"},
    {file:"08_Demara.mp3", title:"8. Ferdinand Waldo Demara"},
    {file:"09_Parker.mp3", title:"9. George Parker"},
    {file:"10_Leviev.mp3", title:"10. Simon Leviev"},
    {file:"11_Chadwick.mp3", title:"11. Cassie Chadwick"},
    {file:"12_McFarland.mp3", title:"12. Billy McFarland"},
    {file:"13_Voigt.mp3", title:"13. Wilhelm Voigt"},
    {file:"14_Valois.mp3", title:"14. Jeanne de Valois-Saint-Rémy"},
    {file:"15_Ferguson.mp3", title:"15. Arthur Ferguson"},
    {file:"16_Pearlman.mp3", title:"16. Lou Pearlman"},
    {file:"17_Valfierno.mp3", title:"17. Eduardo de Valfierno"},
    {file:"18_Marco.mp3", title:"18. Enric Marco"},
    {file:"19_Rocancourt.mp3", title:"19. Christophe Rocancourt"},
    {file:"20_Soapy.mp3", title:"20. Soapy Smith"},
...
function finishQuiz() {
    lifetimeScore += totalScore; localStorage.setItem('betruegerScoreDE', lifetimeScore);
    const fn = decodeURIComponent(audio.src.split('/').pop());
    if(!completedLessons.includes(fn)) { 
        completedLessons.push(fn); 
        localStorage.setItem('completedBetruegerLessonsDE', JSON.stringify(completedLessons)); 
    }
    renderGrid(); 
